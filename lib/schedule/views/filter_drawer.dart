      ...
      children: [
        ...
        DropdownButtonFormField<int>(
          ...
          items: [
            ...
            DropdownMenuItem(value: 2, child: Text('AUTORIZADO')),
            DropdownMenuItem(value: 3, child: Text('EN CAMINO')),
            DropdownMenuItem(value: 4, child: Text('EN PROCESO')),
            DropdownMenuItem(value: 5, child: Text('FINALIZADO')),
            DropdownMenuItem(value: 6, child: Text('CONCLUIDO')),
            DropdownMenuItem(value: 7, child: Text('CANCELADO')),
