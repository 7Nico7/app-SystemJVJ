...
class MaintenanceCheckForm2 extends StatefulWidget {
  final int inspectionId;

  const MaintenanceCheckForm2({Key? key, required this.inspectionId})
      : super(key: key);
...
class _MaintenanceCheckFormState extends State<MaintenanceCheckForm2> {
  ...
  // Menú flotante para navegación entre secciones
  Widget _buildNavigationMenu() {
    return FloatingActionButton(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Wrap(
                    ...
                    children: [
                      _buildSectionButton(
                          'Información General', 'general', Icons.info),
                      _buildSectionButton(
                          'Checks de Mantenimiento', 'checks', Icons.checklist),
                      _buildSectionButton(
                          'Fotos', 'photos', Icons.photo_library),
                      _buildSectionButton('Recomendaciones', 'recommendations',
                          Icons.recommend),
                    ],
                  ),
                ],
      ...
      tooltip: 'Navegar entre secciones',
    );
  }

  Widget _buildSectionButton(String text, String sectionKey, IconData icon) {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      floatingActionButton: _isEditable ? _buildNavigationMenu() : null,
    );
  }
}
